...
namespace InputGLFW
{
	static const int ActionToCode[(long unsigned int) EAction::Maximum]
	{
		GLFW_DONT_CARE,
	...
	static const int KeyToCode[(unsigned long int) EKey::Maximum]
	{
		GLFW_KEY_UNKNOWN,
		GLFW_KEY_SPACE,
		GLFW_KEY_APOSTROPHE,
	...
	static const int MouseToCode[(unsigned long int) EMouse::Maximum]
	{
		GLFW_DONT_CARE,
		GLFW_DONT_CARE,
		GLFW_DONT_CARE,
	...
	static const int CursorToCode[(unsigned long int) ECursor::Maximum]
	{
		GLFW_DONT_CARE,
		GLFW_CURSOR_NORMAL,
		GLFW_CURSOR_HIDDEN,
