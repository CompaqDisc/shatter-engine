...
void CSimpleSound::Tick()
{
	...
	FProfileTimeEntry soundBuffersEntry = FProfileTimeEntry( "Sound Buffers", Sounds.size() );
	FProfileTimeEntry streamBuffersEntry = FProfileTimeEntry( "Stream Buffers", Streams.size() );
	Profiler.AddCounterEntry( soundBuffersEntry, true );
	Profiler.AddCounterEntry( streamBuffersEntry, true );
	...
	FProfileTimeEntry activeSoundBuffersEntry = FProfileTimeEntry( "Active Sound Buffers", ActiveSounds );
	Profiler.AddCounterEntry( activeSoundBuffersEntry, true );
}
